...
A su vez cada uno de los estudiantes podrá experimentar diferentes tipos de contramedidades que son implementadas para mitigar este tipo de ataques.
...
Puede utilizar el script bash dado a continuación, este script correrá el ataque en un loop infinito. Si el ataque es exitoso y se obtiene una shell reversa, el script terminará, de lo contrario seguirá corriendo.
...
Para activar esta protección dirígase al directorio \texttt{server-code} y borre el parámetro \texttt{-fno-stack-protector} en la constante \texttt{FLAGS} del archivo \texttt{Makefile} y proceda a compilar nuevamente el archivo \texttt{stack.c}.
